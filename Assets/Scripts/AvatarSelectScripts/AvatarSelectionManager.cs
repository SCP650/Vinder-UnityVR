...
public class AvatarSelectionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(MultiplayerVRConstants.AVARTAR_SELECTION_NUMBER, out storedAvatarSelectionNumber))
        {
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        ExitGames.Client.Photon.Hashtable playterSelectProp = new ExitGames.Client.Photon.Hashtable() { {MultiplayerVRConstants.AVARTAR_SELECTION_NUMBER, avatarIndex} };
        PhotonNetwork.LocalPlayer.SetCustomProperties(playterSelectProp);
    }
}
